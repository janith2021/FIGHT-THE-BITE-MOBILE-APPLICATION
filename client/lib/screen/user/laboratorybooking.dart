...
class LaboratoryBooking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<LaboratoryBookingProvider>(builder: (context, provider, _) {
      return Scaffold(
              ...
              Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                      left: AllDimensions.px100,
                      right: AllDimensions.px100,
                      top: AllDimensions.px50),
                  child: Text(
                    AllStrings.appointmentdetails,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      CustomTextField(
                          controller: provider.laboratorynamecontroller,
                          hintText: AllStrings.fullname,
                          iconData: Icons.person,
                          label: AllStrings.fullname,
                          errorText: ""),
                      SizedBox(
                        height: AllDimensions.px10,
                      ),
                      CustomTextField(
                          controller: provider.appointmentdatecontroller,
                          hintText: AllStrings.appointmentdate,
                          iconData: Icons.date_range,
                          label: AllStrings.appointmentdate,
                          errorText: ""),
                      SizedBox(
                        height: AllDimensions.px10,
                      ),
                          ...
                          onTap: () {
                            TimePicker.show(
                                ...
                                sheet: TimePickerSheet(
                                    sheetTitle: "Online Booking",
                                    minuteTitle: "Minutes",
                                    hourTitle: "Hours",
                                    saveButtonText: "Save"));
                          },
                          child: CustomTextField(
                              controller: provider.appointmnettimecontroller,
                              hintText: AllStrings.appointmenttime,
                              iconData: Icons.watch_later_outlined,
                              label: AllStrings.appointmenttime,
                              errorText: "")),
                      SizedBox(
                        height: AllDimensions.px10,
                      ),
                      Padding(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              borderRadius:
                                  BorderRadius.circular(AllDimensions.px20),
                                ...
                                Row(
                                  ...
                                  children: [
                                    CustomButton(
                                      ...
                                      text: AllStrings.onlinebooking,
                                      styles: GoogleFonts.poppins(
                                          fontSize: AllDimensions.px15),
                                      btnWidth: AllDimensions.px150,
                                    ),
                                    CustomButton(
